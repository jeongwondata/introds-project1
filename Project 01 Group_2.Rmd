...
## 3.1.10 Geographic Distribution of Fire Incidences by cause
...
## 3.1.12 Analysis of Variance (ANOVA)
...
## 3.2.5 Regression Diagnostics Plots
...
# 3.3 Objective 3: Categorize Types of Fire Incidents and Assess Causes
...
## 3.3.4 CATEGORIZATION: Fire Incident Types and Causes
...
## 3.3.6 Frequency count of causes
```{r}
...
## 3.3.7 Segregation based on states

```{r}
table(fire$STATE)
```

## 3.3.8 Bar chart on fire incidences in States.
...
## 3.3.9 Classification of urban and rural counties in DC,MD and VA.
...
## 3.3.10 Frequency table of causes by area type
...
## 3.3.11 Distibution of fire cause by area type
...
## 3.3.12 Identify risk factors associated with different areas.
...
## 3.3.13 Normality Check for Fire Size
```{r}
