...
# 3.1 Objective 3: Categorize Types of Fire Incidents and Assess Causes
...
We classify correlations as strong when |r| ≥ 0.60. These thresholds are conventional and context-dependent.

- Fuel moisture vs. ERC (strong negative): Higher FM100/FM1000 → lower ERC → wetter fuels suppress fire potential

- Dryness/heat vs. ERC (moderate positive): Higher VPD and (to a lesser extent) TMMX → higher ERC.

- Humidity vs. VPD (strong negative): RMAX/RMIN/SPH increase as VPD decreases (expected: humid air lowers VPD)

- Redundancy: FM100 and FM1000 are highly collinear (carry the same information)

Because FM100–FM1000 and VPD–TMMX are redundant pairs, use FM100 and VPD as the primary drivers in the spatial model.
...
- The map shows pockets of wetter fuels (higher FM100) in central–northern/eastern areas and drier fuels (lower FM100) toward the west/southwest
- Implying higher fire potential where FM100 is low and aligning with hot–dry patterns from VPD/TMMX
...
## 3.3.4.2 BI(Burning index) vs. TMMX
...
## 3.3.5.1.Regression Diagnostics Plots
...
# 3.3.5.2.OLS diagnostic for BI model
...
##  Chapter 4: Conclusion and Recoomendations
...
1. Comprehensive Relationship between Fire Incidents and Environmental Factors
   Fire occurrences across Washington, D.C., Maryland, and Virginia in 2018 were not random events but rather the outcome of interacting geographic, climatic, and anthropogenic factors.
   Among all variables, Vapor Pressure Deficit (VPD), Fuel Moisture (FM100), and Precipitation (PR) emerged as the most critical predictors of fire potential. Drier air (higher VPD), lower fuel moisture, and limited rainfall jointly amplified the Energy Release Component (ERC), indicating greater fire intensity and risk.
   Conversely, high fuel moisture and increased precipitation significantly mitigated fire potential, confirming that dryness and wetness dynamics are the dominant controls on regional fire patterns.
...
3. Regional and Temporal Patterns
   Hot spot analysis revealed that *fire incidents were concentrated in central and eastern parts of Maryland and Virginia*, while western areas were relatively moist and less prone to fire.
   Temporal heat maps suggested a clear seasonal peak during the summer months, when temperature, dryness, and solar radiation interact to reduce fuel moisture.
   Moreover, the cause-based analysis showed that urban areas experienced more human-related fires (residential, electrical, vehicular), whereas rural zones exhibited more natural or vegetation-driven fires, emphasizing the need for region-specific prevention strategies.
...
4. Policy and Management Implications
   ...
   Urban strategy: Strengthen inspections of electrical systems and residential safety.
   Rural strategy: Emphasize vegetation control and fuel reduction under persistent dryness.
     Overall, a data-driven, spatially adaptive fire prevention framework is essential for effective mitigation.
