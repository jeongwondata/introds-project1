...
# Read dataset
```{r}
fire <- read.csv("C:/Users/SIMBAH/Documents/GitHub/introds-project1/Fire incidences DC_VA_MD_cleaned.csv")
```
...
```
```{r}
ggplot(data = fire, aes(x = AREA_TYPE, fill = AREA_TYPE)) +
  geom_bar() +
  labs(title = "Distribution of Fire Incidents by Area Type",
       x = "Area Type",
       y = "Number of Fire Incidents") +
  scale_fill_manual(values = c("steelblue", "orange", "gray")) +
